...
### 5、项目运行
1. 登陆界面
![Image text] (https://github.com/CQJonnyLin/asp.net-core-signalr/blob/master/doc/login.png)
2. 主页
![Image text] (https://github.com/CQJonnyLin/asp.net-core-signalr/blob/master/doc/Index.png)
